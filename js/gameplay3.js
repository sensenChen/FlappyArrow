...
let gameplayState3 = function() {
    ...
    this.numTreesPerInterval = 2; //number of trees at each generation
    this.maxTreesPerInterval = 5; //max number of trees per generation
    this.treespercheckpoint = 40; //number of tree generations to reach the next checkpoint
...
gameplayState3.prototype.finishlevel = function() {
    //movestate to blah
    //increase game speed
    //check if you get .75% of total deers
    if (this.deerScore == 0) {
        this.resetCounters();
        game.result = "Worst";
...
gameplayState3.prototype.resetCounters = function() {
    this.lives = 3;
    this.deerScore = 0;
    ...
    this.numTreesPerInterval = 2;
    
    console.log("counters resetted");
}

gameplayState3.prototype.restartThisLevel = function() {
    this.resetCounters();
...
gameplayState3.prototype.restartPause = function() {
    this.resetCounters();
...
gameplayState3.prototype.goToMainMenu = function() {
    resumeButton.kill();
    restartLevelButton.kill();
    mainMenuButton.kill();
...
gameplayState3.prototype.goToMainMenuFromDeath = function() {
    this.resetCounters();
    mainMenuButtonFromDeath.kill();
    game.state.start("Menu");
}
