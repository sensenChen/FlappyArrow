...
let gameplayState = function() {
    ...
    this.treespercheckpoint = 20; //number of tree generations to reach the next checkpoint
...
gameplayState.prototype.resetCounters = function() {
    this.lives = 3;
    this.deerScore = 0;
...
gameplayState.prototype.restartThisLevel = function() {
    this.resetCounters();
...
gameplayState.prototype.restartPause = function() {
    this.resetCounters();
...
gameplayState.prototype.goToMainMenu = function() {
    resumeButton.kill();
    restartLevelButton.kill();
    mainMenuButton.kill();
...
gameplayState.prototype.goToMainMenuFromDeath = function() {
    this.resetCounters();
    mainMenuButtonFromDeath.kill();
    game.state.start("Menu");
}
