...
gameplayState2.prototype.preload = function() {
...
//adds background...?
gameplayState2.prototype.addbackground = function() {
...
gameplayState2.prototype.generateMap = function(curveFun, type) {
    let range = 60;
    let slice = 360/range;
    let theta = Math.PI/2;
    let distance = 375;
...
gameplayState2.prototype.create = function() {
    //level progress
    /*
...
gameplayState2.prototype.update = function() {
    ...
    if (this.lives > 0 && !game.pause) {
		...
		game.physics.arcade.overlap(this.oneUps,this.deers,this.moveSprites, null, this);
		...
		game.physics.arcade.overlap(this.oneUps,this.cows,this.moveSprites, null, this);
...
gameplayState2.prototype.setVelocity = function(vel) {
    this.obstacles.forEach(function(group) {
        group.forEach(function(item) {
...
gameplayState2.prototype.updateScore = function(arrow, deer) {
    deer.destroy();
    this.deerHit.play();
...
gameplayState2.prototype.updateLife = function(arrow, rock) {
    this.lives -= 1;
...
gameplayState2.prototype.slowDown = function(arrow, cow){
    cow.destroy();
    this.cowHit.play();
...
gameplayState2.prototype.restartfromlastcheckpoint = function() {
...
gameplayState2.prototype.updateprogressbar = function() {
...
//    progress=this.le
    progresswidth = ((100.0/this.levellength)*7*progress)-(100.0/this.levellength)*.29*progress;
...
gameplayState2.prototype.increaseLife = function(arrow, oneUp){
    oneUp.destroy();
